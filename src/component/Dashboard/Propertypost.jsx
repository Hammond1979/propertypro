                            ...
                            <div className='propertypostLabel3'>
                                ...
                                <div>
                                   ...
                                   <input type="text" placeholder='Street / Estate / Neighbourhood' className='inputproperty'/>
                                    {/* <Selectoption labelName="Street / Estate / Neighbourhood" data={["--select--", "Co-working space", "Commercial Property", "House", "Land", "Shortlet"]} /> */}
                                </div>
                            </div>
                            <div>
...
{/* <div className='propertypostWrapper'>
                ...
                <div className='postProperty' style={{backgroundColor: 'red', height: "600px",}}>
                    <h1>Post a property</h1>
                    <p>Put your property in front of millions of home-seekers</p>
                    <form className="propertyForm">
                        <label className='propertypostLabel'>Title</label>
                        ...
                        <div className='propertyBody'>
                            ...
                            <div className='propertypostLabel3'><div>
                                ...
                                <div>
                                    <Selectoption labelName="Street / Estate / Neighbourhood" />
                                    <input type="text" data={["--select--", "Co-working space", "Commercial Property", "House", "Land"]} />
                                </div>
                            </div>
                            <div>
                                <label className='propertypostLabel2'>Description</label>
